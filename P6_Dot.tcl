...
#
# P6_Dot.tcl: Tcl script for re-creating project 'vivado_project'
#
...
proc checkRequiredFiles { origin_dir} {
  set status true
  set files [list \
   "${origin_dir}/verilog/vsrc/axis_fmac.sv" \
   "${origin_dir}/verilog/vsrc/dot.sv" \
...
set files [list \
 [file normalize "${origin_dir}/verilog/vsrc/axis_fmac.sv"] \
 [file normalize "${origin_dir}/verilog/vsrc/dot.sv"] \
 [file normalize "${origin_dir}/verilog/vsrc/dot_20_10.sv"] \
 [file normalize "${origin_dir}/verilog/vsrc/axis_dot_20_10.v"] \
 [file normalize "${origin_dir}/verilog/vsrc/axis_fadd.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sources_1' fileset file properties for remote files
set file "$origin_dir/verilog/vsrc/axis_fmac.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/verilog/vsrc/dot.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/verilog/vsrc/dot_20_10.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj

set file "$origin_dir/verilog/vsrc/axis_fadd.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sources_1] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj
...
# Create 'sim_dot' fileset (if not found)
if {[string equal [get_filesets -quiet sim_dot] ""]} {
  create_fileset -simset sim_dot
}

# Set 'sim_dot' fileset object
set obj [get_filesets sim_dot]
set files [list \
 [file normalize "${origin_dir}/verilog/vtests/dot/tb_dot.sv"] \
 [file normalize "${origin_dir}/verilog/vtests/dot/tb_dot_behav.wcfg"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_dot' fileset file properties for remote files
set file "$origin_dir/verilog/vtests/dot/tb_dot.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_dot] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj


# Set 'sim_dot' fileset file properties for local files
# None

# Set 'sim_dot' fileset properties
set obj [get_filesets sim_dot]
set_property -name "hbs.configure_design_for_hier_access" -value "1" -objects $obj
...
if {[string equal [get_filesets -quiet sim_axis_dot_20_10] ""]} {
  create_fileset -simset sim_axis_dot_20_10
}

# Set 'sim_axis_dot_20_10' fileset object
set obj [get_filesets sim_axis_dot_20_10]
set files [list \
 [file normalize "${origin_dir}/verilog/vtests/dot_20_10/dot_20_10_tb.sv"] \
]
add_files -norecurse -fileset $obj $files

# Set 'sim_axis_dot_20_10' fileset file properties for remote files
set file "$origin_dir/verilog/vtests/dot_20_10/dot_20_10_tb.sv"
set file [file normalize $file]
set file_obj [get_files -of_objects [get_filesets sim_axis_dot_20_10] [list "*$file"]]
set_property -name "file_type" -value "SystemVerilog" -objects $file_obj


# Set 'sim_axis_dot_20_10' fileset file properties for local files
# None
...
# Proc to create BD bd_fmac
proc cr_bd_bd_fmac { parentCell } {
...
# End of cr_bd_bd_fmac()
cr_bd_bd_fmac ""
set_property REGISTERED_WITH_MANAGER "1" [get_files bd_fmac.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files bd_fmac.bd ] 


# Create wrapper file for bd_fmac.bd
...
if { [get_files dot.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/lukefahr/e315/P6_Dot/verilog/vsrc/dot.sv
}
if { [get_files dot_20_10.sv] == "" } {
  import_files -quiet -fileset sources_1 /home/lukefahr/e315/P6_Dot/verilog/vsrc/dot_20_10.sv
}
if { [get_files axis_dot_20_10.v] == "" } {
  import_files -quiet -fileset sources_1 /home/lukefahr/e315/P6_Dot/verilog/vsrc/axis_dot_20_10.v
}
...
# axis_dot_20_10
  ...
  connect_bd_intf_net -intf_net axis_dot_20_10_0_OUTPUT_AXIS [get_bd_intf_pins axis_data_fifo_0/S_AXIS] [get_bd_intf_pins axis_dot_20_10_0/OUTPUT_AXIS]
  ...
  assign_bd_address -offset 0x40001000 -range 0x00001000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_dma_0/S_AXI_LITE/Reg] -force
